...
public class SodiumExtraGameOptionPages {
    ...
    public static OptionPage animation() {
        ...
        groups.add(OptionGroup.createBuilder()
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        ...
                        .setTooltip(new TranslatableText("sodiumextra.option.animations_all.tooltip"))
        ...
        groups.add(OptionGroup.createBuilder()
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        ...
                        .setTooltip(new TranslatableText("sodiumextra.option.animate_water.tooltip"))
                        .setControl(TickBoxControl::new)
                ...
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        ...
                        .setTooltip(new TranslatableText("sodiumextra.option.animate_lava.tooltip"))
                        .setControl(TickBoxControl::new)
                ...
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        ...
                        .setTooltip(new TranslatableText("sodiumextra.option.animate_fire.tooltip"))
                        .setControl(TickBoxControl::new)
                ...
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        ...
                        .setTooltip(new TranslatableText("sodiumextra.option.animate_portal.tooltip"))
                        .setControl(TickBoxControl::new)
                ...
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        .setName(new TranslatableText("sodiumextra.option.block_animations"))
                        .setTooltip(new TranslatableText("sodiumextra.option.block_animations.tooltip"))
                        .setControl(TickBoxControl::new)
                ...
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        ...
                        .setTooltip(new TranslatableText("sodiumextra.option.animate_sculk_sensor.tooltip"))
                        .setControl(TickBoxControl::new)
                ...
                .build());
        return new OptionPage(new TranslatableText("sodiumextra.option.animations"), ImmutableList.copyOf(groups));
    }
    ...
    public static OptionPage particle() {
        ...
        groups.add(OptionGroup.createBuilder()
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        .setName(parseVanillaString("gui.socialInteractions.tab_all"))
                        .setTooltip(new TranslatableText("sodiumextra.option.particles_all.tooltip"))
                        .setControl(TickBoxControl::new)
        ...
        groups.add(OptionGroup.createBuilder()
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        ...
                        .setTooltip(new TranslatableText("sodiumextra.option.rain_splash.tooltip"))
                        .setControl(TickBoxControl::new)
                ...
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        ...
                        .setTooltip(new TranslatableText("sodiumextra.option.block_break.tooltip"))
                        .setControl(TickBoxControl::new)
                ...
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        ...
                        .setTooltip(new TranslatableText("sodiumextra.option.block_breaking.tooltip"))
                        .setControl(TickBoxControl::new)
    ...
    public static OptionPage detail() {
        ...
        groups.add(OptionGroup.createBuilder()
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        .setName(new TranslatableText("sodiumextra.option.sky"))
                        .setTooltip(new TranslatableText("sodiumextra.option.sky.tooltip"))
                        .setControl(TickBoxControl::new)
                        .setBinding((opts, value) -> opts.detailSettings.sky = value, opts -> opts.detailSettings.sky)
                        .build()
                )
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        .setName(new TranslatableText("sodiumextra.option.stars"))
                        .setTooltip(new TranslatableText("sodiumextra.option.stars.tooltip"))
                        .setControl(TickBoxControl::new)
                        .setBinding((opts, value) -> opts.detailSettings.stars = value, opts -> opts.detailSettings.stars)
                        .build()
                )
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        .setName(new TranslatableText("sodiumextra.option.sun_moon"))
                        .setTooltip(new TranslatableText("sodiumextra.option.sun_moon.tooltip"))
                        .setControl(TickBoxControl::new)
                ...
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        ...
                        .setTooltip(new TranslatableText("sodiumextra.option.rain_snow.tooltip"))
                        .setControl(TickBoxControl::new)
                        .setBinding((opts, value) -> opts.detailSettings.rainSnow = value, opts -> opts.detailSettings.rainSnow)
                        .build()
                )
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        .setName(new TranslatableText("sodiumextra.option.biome_colors"))
                        .setTooltip(new TranslatableText("sodiumextra.option.biome_colors.tooltip"))
                        .setControl(TickBoxControl::new)
                ...
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        .setName(new TranslatableText("sodiumextra.option.sky_colors"))
                        .setTooltip(new TranslatableText("sodiumextra.option.sky_colors.tooltip"))
                        .setControl(TickBoxControl::new)
                ...
                .build());
        return new OptionPage(new TranslatableText("sodiumextra.option.details"), ImmutableList.copyOf(groups));
    }
    ...
    public static OptionPage render() {
        ...
        groups.add(OptionGroup.createBuilder()
                .add(OptionImpl.createBuilder(int.class, sodiumExtraOpts)
                        .setName(new TranslatableText("sodiumextra.option.fog"))
                        .setTooltip(new TranslatableText("sodiumextra.option.fog.tooltip"))
                ...
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        .setName(new TranslatableText("sodiumextra.option.light_updates"))
                        .setTooltip(new TranslatableText("sodiumextra.option.light_updates.tooltip"))
                        .setControl(TickBoxControl::new)
        ...
        groups.add(OptionGroup.createBuilder()
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        ...
                        .setTooltip(new TranslatableText("sodiumextra.option.item_frames.tooltip"))
                        .setControl(TickBoxControl::new)
                ...
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        ...
                        .setTooltip(new TranslatableText("sodiumextra.option.armor_stands.tooltip"))
                        .setControl(TickBoxControl::new)
                ...
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        ...
                        .setTooltip(new TranslatableText("sodiumextra.option.paintings.tooltip"))
                        .setControl(TickBoxControl::new)
        ...
        groups.add(OptionGroup.createBuilder()
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        .setName(new TranslatableText("sodiumextra.option.beacon_beam"))
                        .setTooltip(new TranslatableText("sodiumextra.option.beacon_beam.tooltip"))
                        .setControl(TickBoxControl::new)
                ...
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        ...
                        .setTooltip(new TranslatableText("sodiumextra.option.piston.tooltip"))
                        .setControl(TickBoxControl::new)
                        .setBinding((options, value) -> options.renderSettings.piston = value, options -> options.renderSettings.piston)
                        .build()
                )
                .build());
        return new OptionPage(new TranslatableText("sodiumextra.option.render"), ImmutableList.copyOf(groups));
    }
    ...
    public static OptionPage extra() {
        ...
        groups.add(OptionGroup.createBuilder()
                .add(OptionImpl.createBuilder(boolean.class, SodiumExtraGameOptionPages.sodiumExtraOpts)
                        .setName(new TranslatableText("sodiumextra.option.use_fast_random"))
                        .setTooltip(new TranslatableText("sodiumextra.option.use_fast_random.tooltip"))
                        .setControl(TickBoxControl::new)
                ...
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        .setName(new TranslatableText("sodiumextra.option.use_adaptive_sync.name"))
                        .setTooltip(new TranslatableText("sodiumextra.option.use_adaptive_sync.tooltip"))
                        .setControl(TickBoxControl::new)
                ...
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        .setName(new TranslatableText("sodiumextra.option.reduce_resolution_on_mac"))
                        .setTooltip(new TranslatableText("sodiumextra.option.reduce_resolution_on_mac.tooltip"))
        ...
        groups.add(OptionGroup.createBuilder()
                .add(OptionImpl.createBuilder(SodiumExtraGameOptions.OverlayCorner.class, sodiumExtraOpts)
                        .setName(new TranslatableText("sodiumextra.option.overlay_corner"))
                        .setTooltip(new TranslatableText("sodiumextra.option.overlay_corner.tooltip"))
                ...
                .add(OptionImpl.createBuilder(SodiumExtraGameOptions.TextContrast.class, sodiumExtraOpts)
                        .setName(new TranslatableText("sodiumextra.option.text_contrast"))
                        .setTooltip(new TranslatableText("sodiumextra.option.text_contrast.tooltip"))
                ...
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        .setName(new TranslatableText("sodiumextra.option.show_fps"))
                        .setTooltip(new TranslatableText("sodiumextra.option.show_fps.tooltip"))
                        .setControl(TickBoxControl::new)
                        .setBinding((opts, value) -> opts.extraSettings.showFps = value, opts -> opts.extraSettings.showFps)
                        .build()
                )
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        .setName(new TranslatableText("sodiumextra.option.show_fps_extended"))
                        .setTooltip(new TranslatableText("sodiumextra.option.show_fps_extended.tooltip"))
                        .setControl(TickBoxControl::new)
                        .setBinding((opts, value) -> opts.extraSettings.showFPSExtended = value, opts -> opts.extraSettings.showFPSExtended)
                        .build()
                )
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        .setName(new TranslatableText("sodiumextra.option.show_coordinates"))
                        .setTooltip(new TranslatableText("sodiumextra.option.show_coordinates.tooltip"))
                        .setControl(TickBoxControl::new)
                        .setBinding((opts, value) -> opts.extraSettings.showCoords = value, opts -> opts.extraSettings.showCoords)
                        .build()
                )
                .add(OptionImpl.createBuilder(int.class, sodiumExtraOpts)
                        .setName(new TranslatableText("sodiumextra.option.cloud_height"))
                        .setTooltip(new TranslatableText("sodiumextra.option.cloud_height.tooltip"))
                ...
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        .setName(new TranslatableText("sodiumextra.option.toasts"))
                        .setTooltip(new TranslatableText("sodiumextra.option.toasts.tooltip"))
                        .setControl(TickBoxControl::new)
                        .setBinding((options, value) -> options.extraSettings.toasts = value, options -> options.extraSettings.toasts)
                        .build())
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        .setName(new TranslatableText("sodiumextra.option.instant_sneak"))
                        .setTooltip(new TranslatableText("sodiumextra.option.instant_sneak.tooltip"))
                        .setControl(TickBoxControl::new)
                        .setBinding((options, value) -> options.extraSettings.instantSneak = value, options -> options.extraSettings.instantSneak)
                        .build()
                )
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        .setName(new TranslatableText("sodiumextra.option.prevent_shaders"))
                        .setTooltip(new TranslatableText("sodiumextra.option.prevent_shaders.tooltip"))
                        .setControl(TickBoxControl::new)
        ...
        return new OptionPage(new TranslatableText("sodiumextra.option.extras"), ImmutableList.copyOf(groups));
    }
