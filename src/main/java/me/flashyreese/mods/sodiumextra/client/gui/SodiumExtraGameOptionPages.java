...
public class SodiumExtraGameOptionPages {
    ...
    public static OptionPage animation() {
        ...
        groups.add(OptionGroup.createBuilder()
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        ...
                        .setTooltip(Text.translatable("sodiumextra.option.animations_all.tooltip"))
        ...
        groups.add(OptionGroup.createBuilder()
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        ...
                        .setTooltip(Text.translatable("sodiumextra.option.animate_water.tooltip"))
                        .setControl(TickBoxControl::new)
                ...
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        ...
                        .setTooltip(Text.translatable("sodiumextra.option.animate_lava.tooltip"))
                        .setControl(TickBoxControl::new)
                ...
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        ...
                        .setTooltip(Text.translatable("sodiumextra.option.animate_fire.tooltip"))
                        .setControl(TickBoxControl::new)
                ...
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        ...
                        .setTooltip(Text.translatable("sodiumextra.option.animate_portal.tooltip"))
                        .setControl(TickBoxControl::new)
                ...
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        .setName(Text.translatable("sodiumextra.option.block_animations"))
                        .setTooltip(Text.translatable("sodiumextra.option.block_animations.tooltip"))
                        .setControl(TickBoxControl::new)
                ...
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        ...
                        .setTooltip(Text.translatable("sodiumextra.option.animate_sculk_sensor.tooltip"))
                        .setControl(TickBoxControl::new)
                ...
                .build());
        return new OptionPage(Text.translatable("sodiumextra.option.animations"), ImmutableList.copyOf(groups));
    }
    ...
    public static OptionPage particle() {
        ...
        groups.add(OptionGroup.createBuilder()
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        .setName(parseVanillaString("gui.socialInteractions.tab_all"))
                        .setTooltip(Text.translatable("sodiumextra.option.particles_all.tooltip"))
                        .setControl(TickBoxControl::new)
        ...
        groups.add(OptionGroup.createBuilder()
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        ...
                        .setTooltip(Text.translatable("sodiumextra.option.rain_splash.tooltip"))
                        .setControl(TickBoxControl::new)
                ...
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        ...
                        .setTooltip(Text.translatable("sodiumextra.option.block_break.tooltip"))
                        .setControl(TickBoxControl::new)
                ...
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        ...
                        .setTooltip(Text.translatable("sodiumextra.option.block_breaking.tooltip"))
                        .setControl(TickBoxControl::new)
    ...
    public static OptionPage detail() {
        ...
        groups.add(OptionGroup.createBuilder()
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        .setName(Text.translatable("sodiumextra.option.sky"))
                        .setTooltip(Text.translatable("sodiumextra.option.sky.tooltip"))
                        .setControl(TickBoxControl::new)
                        .setBinding((opts, value) -> opts.detailSettings.sky = value, opts -> opts.detailSettings.sky)
                        .build()
                )
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        .setName(Text.translatable("sodiumextra.option.stars"))
                        .setTooltip(Text.translatable("sodiumextra.option.stars.tooltip"))
                        .setControl(TickBoxControl::new)
                        .setBinding((opts, value) -> opts.detailSettings.stars = value, opts -> opts.detailSettings.stars)
                        .build()
                )
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        .setName(Text.translatable("sodiumextra.option.sun_moon"))
                        .setTooltip(Text.translatable("sodiumextra.option.sun_moon.tooltip"))
                        .setControl(TickBoxControl::new)
                ...
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        ...
                        .setTooltip(Text.translatable("sodiumextra.option.rain_snow.tooltip"))
                        .setControl(TickBoxControl::new)
                        .setBinding((opts, value) -> opts.detailSettings.rainSnow = value, opts -> opts.detailSettings.rainSnow)
                        .build()
                )
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        .setName(Text.translatable("sodiumextra.option.biome_colors"))
                        .setTooltip(Text.translatable("sodiumextra.option.biome_colors.tooltip"))
                        .setControl(TickBoxControl::new)
                ...
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        .setName(Text.translatable("sodiumextra.option.sky_colors"))
                        .setTooltip(Text.translatable("sodiumextra.option.sky_colors.tooltip"))
                        .setControl(TickBoxControl::new)
                ...
                .build());
        return new OptionPage(Text.translatable("sodiumextra.option.details"), ImmutableList.copyOf(groups));
    }
    ...
    public static OptionPage render() {
        ...
        groups.add(OptionGroup.createBuilder()
                .add(OptionImpl.createBuilder(int.class, sodiumExtraOpts)
                        .setName(Text.translatable("sodiumextra.option.fog"))
                        .setTooltip(Text.translatable("sodiumextra.option.fog.tooltip"))
                ...
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        .setName(Text.translatable("sodiumextra.option.light_updates"))
                        .setTooltip(Text.translatable("sodiumextra.option.light_updates.tooltip"))
                        .setControl(TickBoxControl::new)
        ...
        groups.add(OptionGroup.createBuilder()
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        ...
                        .setTooltip(Text.translatable("sodiumextra.option.item_frames.tooltip"))
                        .setControl(TickBoxControl::new)
                ...
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        ...
                        .setTooltip(Text.translatable("sodiumextra.option.armor_stands.tooltip"))
                        .setControl(TickBoxControl::new)
                ...
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        ...
                        .setTooltip(Text.translatable("sodiumextra.option.paintings.tooltip"))
                        .setControl(TickBoxControl::new)
        ...
        groups.add(OptionGroup.createBuilder()
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        .setName(Text.translatable("sodiumextra.option.beacon_beam"))
                        .setTooltip(Text.translatable("sodiumextra.option.beacon_beam.tooltip"))
                        .setControl(TickBoxControl::new)
                ...
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        ...
                        .setTooltip(Text.translatable("sodiumextra.option.piston.tooltip"))
                        .setControl(TickBoxControl::new)
                        .setBinding((options, value) -> options.renderSettings.piston = value, options -> options.renderSettings.piston)
                        .build()
                )
                .build());
        return new OptionPage(Text.translatable("sodiumextra.option.render"), ImmutableList.copyOf(groups));
    }
    ...
    public static OptionPage extra() {
        ...
        groups.add(OptionGroup.createBuilder()
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        .setName(Text.translatable("sodiumextra.option.use_adaptive_sync.name"))
                        .setTooltip(Text.translatable("sodiumextra.option.use_adaptive_sync.tooltip"))
                        .setControl(TickBoxControl::new)
                ...
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        .setName(Text.translatable("sodiumextra.option.reduce_resolution_on_mac"))
                        .setTooltip(Text.translatable("sodiumextra.option.reduce_resolution_on_mac.tooltip"))
        ...
        groups.add(OptionGroup.createBuilder()
                .add(OptionImpl.createBuilder(SodiumExtraGameOptions.OverlayCorner.class, sodiumExtraOpts)
                        .setName(Text.translatable("sodiumextra.option.overlay_corner"))
                        .setTooltip(Text.translatable("sodiumextra.option.overlay_corner.tooltip"))
                ...
                .add(OptionImpl.createBuilder(SodiumExtraGameOptions.TextContrast.class, sodiumExtraOpts)
                        .setName(Text.translatable("sodiumextra.option.text_contrast"))
                        .setTooltip(Text.translatable("sodiumextra.option.text_contrast.tooltip"))
                ...
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        .setName(Text.translatable("sodiumextra.option.show_fps"))
                        .setTooltip(Text.translatable("sodiumextra.option.show_fps.tooltip"))
                        .setControl(TickBoxControl::new)
                        .setBinding((opts, value) -> opts.extraSettings.showFps = value, opts -> opts.extraSettings.showFps)
                        .build()
                )
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        .setName(Text.translatable("sodiumextra.option.show_fps_extended"))
                        .setTooltip(Text.translatable("sodiumextra.option.show_fps_extended.tooltip"))
                        .setControl(TickBoxControl::new)
                        .setBinding((opts, value) -> opts.extraSettings.showFPSExtended = value, opts -> opts.extraSettings.showFPSExtended)
                        .build()
                )
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        .setName(Text.translatable("sodiumextra.option.show_coordinates"))
                        .setTooltip(Text.translatable("sodiumextra.option.show_coordinates.tooltip"))
                        .setControl(TickBoxControl::new)
                        .setBinding((opts, value) -> opts.extraSettings.showCoords = value, opts -> opts.extraSettings.showCoords)
                        .build()
                )
                .add(OptionImpl.createBuilder(int.class, sodiumExtraOpts)
                        .setName(Text.translatable("sodiumextra.option.cloud_height"))
                        .setTooltip(Text.translatable("sodiumextra.option.cloud_height.tooltip"))
                ...
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        .setName(Text.translatable("sodiumextra.option.toasts"))
                        .setTooltip(Text.translatable("sodiumextra.option.toasts.tooltip"))
                        .setControl(TickBoxControl::new)
                        .setBinding((options, value) -> options.extraSettings.toasts = value, options -> options.extraSettings.toasts)
                        .build())
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        .setName(Text.translatable("sodiumextra.option.instant_sneak"))
                        .setTooltip(Text.translatable("sodiumextra.option.instant_sneak.tooltip"))
                        .setControl(TickBoxControl::new)
                        .setBinding((options, value) -> options.extraSettings.instantSneak = value, options -> options.extraSettings.instantSneak)
                        .build()
                )
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        .setName(Text.translatable("sodiumextra.option.prevent_shaders"))
                        .setTooltip(Text.translatable("sodiumextra.option.prevent_shaders.tooltip"))
                        .setControl(TickBoxControl::new)
        ...
        return new OptionPage(Text.translatable("sodiumextra.option.extras"), ImmutableList.copyOf(groups));
    }
