...
public class SodiumExtraGameOptionPages {
    ...
    public static OptionPage animation() {
        ...
        groups.add(OptionGroup.createBuilder()
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        ...
                        .setTooltip(new TranslatableText("sodiumextra.option.animations_all.tooltip").getString())
        ...
        groups.add(OptionGroup.createBuilder()
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        ...
                        .setTooltip(new TranslatableText("sodiumextra.option.animate_water.tooltip").getString())
                        .setControl(TickBoxControl::new)
                ...
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        ...
                        .setTooltip(new TranslatableText("sodiumextra.option.animate_lava.tooltip").getString())
                        .setControl(TickBoxControl::new)
                ...
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        ...
                        .setTooltip(new TranslatableText("sodiumextra.option.animate_fire.tooltip").getString())
                        .setControl(TickBoxControl::new)
                ...
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        ...
                        .setTooltip(new TranslatableText("sodiumextra.option.animate_portal.tooltip").getString())
                        .setControl(TickBoxControl::new)
                ...
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        .setName(new TranslatableText("sodiumextra.option.block_animations").getString())
                        .setTooltip(new TranslatableText("sodiumextra.option.block_animations.tooltip").getString())
                        .setControl(TickBoxControl::new)
                ...
                .build());
        return new OptionPage(new TranslatableText("sodiumextra.option.animations").getString(), ImmutableList.copyOf(groups));
    }
    ...
    public static OptionPage particle() {
        ...
        groups.add(OptionGroup.createBuilder()
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        .setName(parseVanillaString("gui.socialInteractions.tab_all"))
                        .setTooltip(new TranslatableText("sodiumextra.option.particles_all.tooltip").getString())
                        .setControl(TickBoxControl::new)
        ...
        groups.add(OptionGroup.createBuilder()
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        ...
                        .setTooltip(new TranslatableText("sodiumextra.option.rain_splash.tooltip").getString())
                        .setControl(TickBoxControl::new)
                ...
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        ...
                        .setTooltip(new TranslatableText("sodiumextra.option.block_break.tooltip").getString())
                        .setControl(TickBoxControl::new)
                ...
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        ...
                        .setTooltip(new TranslatableText("sodiumextra.option.block_breaking.tooltip").getString())
                        .setControl(TickBoxControl::new)
    ...
    public static OptionPage detail() {
        ...
        groups.add(OptionGroup.createBuilder()
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        .setName(new TranslatableText("sodiumextra.option.sky").getString())
                        .setTooltip(new TranslatableText("sodiumextra.option.sky.tooltip").getString())
                        .setControl(TickBoxControl::new)
                        .setBinding((opts, value) -> opts.detailSettings.sky = value, opts -> opts.detailSettings.sky)
                        .build()
                )
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        .setName(new TranslatableText("sodiumextra.option.stars").getString())
                        .setTooltip(new TranslatableText("sodiumextra.option.stars.tooltip").getString())
                        .setControl(TickBoxControl::new)
                        .setBinding((opts, value) -> opts.detailSettings.stars = value, opts -> opts.detailSettings.stars)
                        .build()
                )
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        .setName(new TranslatableText("sodiumextra.option.sun_moon").getString())
                        .setTooltip(new TranslatableText("sodiumextra.option.sun_moon.tooltip").getString())
                        .setControl(TickBoxControl::new)
                ...
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        ...
                        .setTooltip(new TranslatableText("sodiumextra.option.rain_snow.tooltip").getString())
                        .setControl(TickBoxControl::new)
                        .setBinding((opts, value) -> opts.detailSettings.rainSnow = value, opts -> opts.detailSettings.rainSnow)
                        .build()
                )
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        .setName(new TranslatableText("sodiumextra.option.biome_colors").getString())
                        .setTooltip(new TranslatableText("sodiumextra.option.biome_colors.tooltip").getString())
                        .setControl(TickBoxControl::new)
                ...
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        .setName(new TranslatableText("sodiumextra.option.sky_colors").getString())
                        .setTooltip(new TranslatableText("sodiumextra.option.sky_colors.tooltip").getString())
                        .setControl(TickBoxControl::new)
                ...
                .build());
        return new OptionPage(new TranslatableText("sodiumextra.option.details").getString(), ImmutableList.copyOf(groups));
    }
    ...
    public static OptionPage render() {
        ...
        groups.add(OptionGroup.createBuilder()
                .add(OptionImpl.createBuilder(int.class, sodiumExtraOpts)
                        .setName(new TranslatableText("sodiumextra.option.fog").getString())
                        .setTooltip(new TranslatableText("sodiumextra.option.fog.tooltip").getString())
                ...
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        .setName(new TranslatableText("sodiumextra.option.light_updates").getString())
                        .setTooltip(new TranslatableText("sodiumextra.option.light_updates.tooltip").getString())
                        .setControl(TickBoxControl::new)
        ...
        groups.add(OptionGroup.createBuilder()
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        ...
                        .setTooltip(new TranslatableText("sodiumextra.option.item_frames.tooltip").getString())
                        .setControl(TickBoxControl::new)
                ...
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        ...
                        .setTooltip(new TranslatableText("sodiumextra.option.armor_stands.tooltip").getString())
                        .setControl(TickBoxControl::new)
                ...
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        ...
                        .setTooltip(new TranslatableText("sodiumextra.option.paintings.tooltip").getString())
                        .setControl(TickBoxControl::new)
        ...
        groups.add(OptionGroup.createBuilder()
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        .setName(new TranslatableText("sodiumextra.option.beacon_beam").getString())
                        .setTooltip(new TranslatableText("sodiumextra.option.beacon_beam.tooltip").getString())
                        .setControl(TickBoxControl::new)
                ...
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        ...
                        .setTooltip(new TranslatableText("sodiumextra.option.piston.tooltip").getString())
                        .setControl(TickBoxControl::new)
                        .setBinding((options, value) -> options.renderSettings.piston = value, options -> options.renderSettings.piston)
                        .build()
                )
                .build());
        return new OptionPage(new TranslatableText("sodiumextra.option.render").getString(), ImmutableList.copyOf(groups));
    }
    ...
    public static OptionPage extra() {
        ...
        groups.add(OptionGroup.createBuilder()
                .add(OptionImpl.createBuilder(boolean.class, SodiumExtraGameOptionPages.sodiumExtraOpts)
                        .setName(new TranslatableText("sodiumextra.option.use_fast_random").getString())
                        .setTooltip(new TranslatableText("sodiumextra.option.use_fast_random.tooltip").getString())
                        .setControl(TickBoxControl::new)
                ...
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        .setName(new TranslatableText("sodiumextra.option.use_adaptive_sync.name").getString())
                        .setTooltip(new TranslatableText("sodiumextra.option.use_adaptive_sync.tooltip").getString())
                        .setControl(TickBoxControl::new)
                ...
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        .setName(new TranslatableText("sodiumextra.option.reduce_resolution_on_mac").getString())
                        .setTooltip(new TranslatableText("sodiumextra.option.reduce_resolution_on_mac.tooltip").getString())
        ...
        groups.add(OptionGroup.createBuilder()
                .add(OptionImpl.createBuilder(SodiumExtraGameOptions.OverlayCorner.class, sodiumExtraOpts)
                        .setName(new TranslatableText("sodiumextra.option.overlay_corner").getString())
                        .setTooltip(new TranslatableText("sodiumextra.option.overlay_corner.tooltip").getString())
                ...
                .add(OptionImpl.createBuilder(SodiumExtraGameOptions.TextContrast.class, sodiumExtraOpts)
                        .setName(new TranslatableText("sodiumextra.option.text_contrast").getString())
                        .setTooltip(new TranslatableText("sodiumextra.option.text_contrast.tooltip").getString())
                ...
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        .setName(new TranslatableText("sodiumextra.option.show_fps").getString())
                        .setTooltip(new TranslatableText("sodiumextra.option.show_fps.tooltip").getString())
                        .setControl(TickBoxControl::new)
                        .setBinding((opts, value) -> opts.extraSettings.showFps = value, opts -> opts.extraSettings.showFps)
                        .build()
                )
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        .setName(new TranslatableText("sodiumextra.option.show_fps_extended").getString())
                        .setTooltip(new TranslatableText("sodiumextra.option.show_fps_extended.tooltip").getString())
                        .setControl(TickBoxControl::new)
                        .setBinding((opts, value) -> opts.extraSettings.showFPSExtended = value, opts -> opts.extraSettings.showFPSExtended)
                        .build()
                )
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        .setName(new TranslatableText("sodiumextra.option.show_coordinates").getString())
                        .setTooltip(new TranslatableText("sodiumextra.option.show_coordinates.tooltip").getString())
                        .setControl(TickBoxControl::new)
                        .setBinding((opts, value) -> opts.extraSettings.showCoords = value, opts -> opts.extraSettings.showCoords)
                        .build()
                )
                .add(OptionImpl.createBuilder(int.class, sodiumExtraOpts)
                        .setName(new TranslatableText("sodiumextra.option.cloud_height").getString())
                        .setTooltip(new TranslatableText("sodiumextra.option.cloud_height.tooltip").getString())
                ...
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        .setName(new TranslatableText("sodiumextra.option.toasts").getString())
                        .setTooltip(new TranslatableText("sodiumextra.option.toasts.tooltip").getString())
                        .setControl(TickBoxControl::new)
                        .setBinding((options, value) -> options.extraSettings.toasts = value, options -> options.extraSettings.toasts)
                        .build()
                )
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        .setName(new TranslatableText("sodiumextra.option.instant_sneak").getString())
                        .setTooltip(new TranslatableText("sodiumextra.option.instant_sneak.tooltip").getString())
                        .setControl(TickBoxControl::new)
                        .setBinding((options, value) -> options.extraSettings.instantSneak = value, options -> options.extraSettings.instantSneak)
                        .build()
                )
                .add(OptionImpl.createBuilder(boolean.class, sodiumExtraOpts)
                        .setName(new TranslatableText("sodiumextra.option.prevent_shaders").getString())
                        .setTooltip(new TranslatableText("sodiumextra.option.prevent_shaders.tooltip").getString())
                        .setControl(TickBoxControl::new)
        ...
        return new OptionPage(new TranslatableText("sodiumextra.option.extras").getString(), ImmutableList.copyOf(groups));
    }
    ...
    private static Text translatableTooltip(Identifier identifier, String category) {
        ...
        if (translatable.getString().equals(key)) {
            translatable = new TranslatableText(
                    "sodiumextra.option.".concat(category).concat(".tooltips"),
